DROP DATABASE IF EXISTS `codis`;

CREATE DATABASE  `codis` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE USER 'codis'@'%' IDENTIFIED BY 'codi@2020';

GRANT ALL PRIVILEGES ON *.* TO 'codis'@'%';
